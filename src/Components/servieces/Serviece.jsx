      ...
      <div className="container services_container">
        <article className="services">
          ...
          <ul className="services_list">
            ...
            <li>
              <BiCheck className="service_list-icon" />
              <p>
                Prototyping of user interface for both websites and mobile app{" "}
              </p>
            </li>
            <li>
              <BiCheck className="service_list-icon" />
              <p>Visual Design (UI Design) for both websites and mobile app</p>
            </li>
            <li>
              <BiCheck className="service_list-icon" />
            ...
            <li>
              <BiCheck className="service_list-icon" />
              <p>Usability Testing and Iterative UX Improvements</p>
            </li>
          </ul>
        </article>
        ...
        <article className="services">
          ...
          <ul className="services_list">
            <li>
              <BiCheck className="service_list-icon" />
              <p>
                Developing different type of websites for different purpose{" "}
              </p>
            </li>
            <li>
              <BiCheck className="service_list-icon" />
            ...
            <li>
              <BiCheck className="service_list-icon" />
              <p>Develop cross-platform and custom mobile app </p>
            </li>
          </ul>
        </article>
        ...
        <article className="services">
          ...
          <ul className="services_list">
            ...
            <li>
              <BiCheck className="service_list-icon" />
              <p>Developing and optimizing content for mobile applications </p>
            </li>
          </ul>
        </article>
      </div>
